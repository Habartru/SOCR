...
│  │ • Локальная     │  │                  │  │ • Облачная      │  │
│  │   модель        │  │                  │  │   модель        │  │
│  │ • Phi-4, Phi-4-Q3_K_L │  │                  │  │ • gpt-4o-mini    │  │
│  │ • Мультиязычная │  │                  │  │ • gpt-4.1-mini/nano │  │
...
1. **LM Studio**:
   - **Microsoft/phi-4** (6B параметров) - основная рекомендуемая модель
   - **Microsoft/phi-4-Q3_K_L** - облегченная версия с меньшими требованиями к памяти GPU
   - Имена моделей для использования в системе: `local-1` и `local-2`

2. **OpenAI API**:
   - **gpt-4o-mini** - оптимальная производительность
   - **gpt-4.1-mini** и **gpt-4.1-nano** - эффективные по соотношению цена/качество
